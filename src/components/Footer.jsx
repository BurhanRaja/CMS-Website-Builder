...
const Footer = () => {
  return (
            ...
            <aside className="col-xl-4">
              <div className="footerLogo">
                ...
                <p>
                  ...
                  tincidunt ultricies velit penatibus arcu lectus malesuada
                  vulputate. Quam convallis curabitur dui, adipiscing egestas
                  laoreet cursus.
                </p>
              </div>
            </aside>
            <aside className="col-xl-8">
              <div className="row">
                ...
                <aside className="col-md-3 col-sm-6">
                  <div className="footerContact">
                    <h3>Contact</h3>
                    <ul className="footerConList">
                      <li>
                        <a href="tel:+91 6 3589 07931">
                          <SvgIcon>
                            <svg
                              version="1.1"
                              ...
                              y="0px"
                              viewBox="0 0 26 23"
                              style={{ enableBackground: "new 0 0 26 23" }}
                              xmlSpace="preserve"
                            >
                              <path
                                className="st0"
                                d="M25.2,17.6L19.4,13c-0.3-0.2-0.6-0.3-1-0.3c-0.4,0-0.7,0.1-1,0.4l-3.4,3c-0.8-0.1-2.5-0.6-4.2-2
                              c-1.7-1.5-2.2-2.9-2.4-3.6L11,7.5c0.3-0.2,0.4-0.5,0.4-0.8c0-0.3-0.1-0.6-0.4-0.9l-5.2-5c-0.2-0.2-0.6-0.4-1-0.4
                              c-0.4,0-0.7,0.1-1,0.3L0.8,3C0.5,3.2,0.4,3.5,0.4,3.8C0.4,4.1,0,11.4,6.5,17c5.7,4.9,12.8,5.3,14.8,5.3c0.3,0,0.5,0,0.5,0
                              c0.3,0,0.7-0.1,0.9-0.4l2.6-2.7c0.2-0.2,0.4-0.6,0.3-0.9C25.6,18.1,25.4,17.8,25.2,17.6z"
                              />
                            </svg>
                          </SvgIcon>
                          +91 6 3589 07931
                      ...
                      <li>
                        <a href="mailto:contact@techysquad.com">
                          <SvgIcon>
                            <svg
                              version="1.1"
                              xmlns="http://www.w3.org/2000/svg"
                            ...
                            >
                              <path
                                className="st0"
                                d="M24.6,1.6H1.4C0.9,1.6,0.5,2,0.5,2.5v18c0,0.5,0.4,0.9,0.9,0.9h23.3c0.5,0,0.9-0.4,0.9-0.9v-18
                              C25.5,2,25.1,1.6,24.6,1.6z M22.4,4.7l-8.8,6.9c-0.2,0.2-0.5,0.2-0.7,0L4,4.7c0,0-0.1-0.1-0.1-0.1c0,0,0-0.1,0-0.1
                              c0,0,0-0.1,0.1-0.1c0,0,0.1,0,0.1,0h18.2c0,0,0.1,0,0.1,0c0,0,0.1,0.1,0.1,0.1c0,0,0,0.1,0,0.1C22.4,4.6,22.4,4.6,22.4,4.7z"
                              />
                            </svg>
                          </SvgIcon>
                        ...
                        <a href="#">
                          <SvgIcon>
                            <svg
                              ...
                              y="0px"
                              viewBox="0 0 30 30"
                              style={{ enableBackground: "new 0 0 16.67 30" }}
                              xmlSpace="preserve"
                            >
                              <path
                                className="st0"
	...
	c0,0-1.44-0.01-3.01-0.01c-1.7,0-1.97,0.73-1.97,1.95v3.22h5.12l-0.22,4.41H9.48v12.25H4.49z"
          ...
          <div className="copy">
            {" "}
            &copy; 2022 All rights reserved. <a href="#">
              Techysquad.com
            </a> | <a href="#">Disclaimer</a> | <a href="#">Privacy Policy</a>
          </div>
        </div>
      </footer>
    </>
